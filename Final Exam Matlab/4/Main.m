...
for i=4:n
    ...
    y2(i+1)=y2(i)+(h/24)*(9*f(t(i),y2(i))+19*f(t(i-1),y2(i-1))-5*f(t(i-2),y2(i-2)+f(t(i-3),y2(i-3))));
    ey2(i+1)=abs(y2(i+1)-ye(i+1));
    y(i+1)=y(i)+(h/24)*(9*f(t(i+1),y2(i+1))+19*f(t(i),y1(i))-5*f(t(i-1),y1(i-1))+f(t(i-2),y1(i-2)));
